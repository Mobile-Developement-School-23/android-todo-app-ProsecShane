...
//class EditorFragment : Fragment(R.layout.fragment_item) {
...
//        todoItem = if (todoItemsViewModel.currentTodoPos.value == -1) {
//            TodoItem(
//                id = todoItemsViewModel.currentTodoItem.value!!,
//                text = "",
...
//            )
//        } else {
//            todoItemsViewModel.todoItemsRepository.value!!
//                .items[todoItemsViewModel.currentTodoPos.value!!]
//        }
//
...
//            if (todoItemsViewModel.currentTodoPos.value != -1) {
//                // Сохраняем данные во ВьюМодел
//                todoItemsViewModel.todoItemsRepository.value!!.items[
//                        todoItemsViewModel.currentTodoPos.value!!
//                ] = todoItem
//            } else {
//                // Иначе добавляем новые данные во ВьюМодел
//                todoItemsViewModel.todoItemsRepository.value!!.items.add(todoItem)
//            }
...
//                todoItemsViewModel.todoItemsRepository.value!!.items.removeAt(
//                    todoItemsViewModel.currentTodoPos.value!!
//                )
//            }
//            // Переходим к начальному фрагменту
